...
a=h.join(" ");this.name in this.params?c.push("["+a+"]"):c.push("["+this.name+" "+a+"]")}else c.push("["+this.name+"]");c.push(this.getContent(!b));null!==this.name&&(e=this.name,0>q.call(this.CLOSED_BY,e))&&c.push("[/"+this.name+"]");return c.join("")};g.prototype._toHTML=function(){return this.toText(!0)};g.prototype.toHTML=function(){var a;a=this._toHTML();return"string"===typeof a?a:a.join("")};k.Tag=g;var s=function(){s.__super__.constructor.apply(this,arguments);this.STRIP_INNER=!0;this._inline=
...
"width"in this.params&&(a.width=this.params.width);"height"in this.params&&(a.height=this.params.height);return"<img "+this.renderer.htmlAttributes(a)+" />"};e=t;var u=function(){return G=u.__super__.constructor.apply(this,arguments)};l(u,this.bbcode.Tag);u.prototype._toHTML=function(){var a;a=this.params.size;return isNaN(a)?this.getContent():['<span style="font-size:'+a+'px">',this.getContent(),"</span>"]};E=u;var v=function(){return H=v.__super__.constructor.apply(this,arguments)};l(v,this.bbcode.Tag);
v.prototype._toHTML=function(){var a;a=this.params.color;return null!=a?['<span style="color:'+a+'">',this.getContent(),"</span>"]:this.getContent()};j=v;var w=function(){return m=w.__super__.constructor.apply(this,arguments)};l(w,this.bbcode.Tag);w.prototype._toHTML=function(){return['<div style="text-align:center;">',this.getContent(),"</div>"]};k=w;var x=function(){return p=x.__super__.constructor.apply(this,arguments)};l(x,this.bbcode.Tag);x.prototype._toHTML=function(){return['<div style="float:right;">',
this.getContent(),"</div>"]};D=x;var y=function(){y.__super__.constructor.apply(this,arguments);this.STRIP_OUTER=this.SELF_CLOSE=!0};l(y,this.bbcode.Tag);y.prototype._toHTML=function(){return"<hr />"};d=y;var z=function(){z.__super__.constructor.apply(this,arguments);this.STRIP_OUTER=this.STRIP_INNER=!0};l(z,this.bbcode.Tag);z.prototype._toHTML=function(){var a;a=this.params.list;return"1"===a?["<ol>",this.getContent(),"</ol>"]:"a"===a?['<ol style="list-style-type:lower-alpha;">',this.getContent(),
...
{DISCARD_TEXT:!0}),tr:this.bbcode.createSimpleTag("tr",{DISCARD_TEXT:!0}),th:this.bbcode.createSimpleTag("th"),td:this.bbcode.createSimpleTag("td"),sup:this.bbcode.createSimpleTag("sup"),sub:this.bbcode.createSimpleTag("sub"),code:g,img:e,hr:d,size:E,center:k,right:D,color:j,list:a,"*":b,quote:c,url:f,link:f}}).call(this);
