...
// Generated by CoffeeScript 1.6.2
(function() {
  var CenterTag, CodeTag, ColorTag, HorizontalRuleTag, ImageTag, LinkTag, ListItemTag, ListTag, OverlineTag, QuoteTag, RightTag, SizeTag, _LINE_BREAK, _NEWLINE_RE, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
  ...
  OverlineTag = (function(_super) {
    ...
    OverlineTag.prototype._toHTML = function() {
      return "<span style=\"text-decoration: overline;\">" + (this.getContent(true)) + "</span>";
    };
